...
Almost the same as <a href="#role-playing-die">the previous</a>, but with grouping for parsing like in the <a href="./blob/master/src/main/java/se/blinfo/regexp/sample/RolePlayingDieValidator.java">RolePlayingDieParser</a>.
